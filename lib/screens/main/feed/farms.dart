...
class FarmsFeed extends StatelessWidget {
  const FarmsFeed({super.key});
                    ...
                    return ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          if (category == 'farm') {
                            ...
                            return SmallText(
                              text: 'Oops! sory, no farms in the database yet.',
            ...
            return Scaffold(
              body: Center(
                child: Column(
                  ...
                  children: [
                    SmallText(
                      text: 'Oops! sory we can\'t fetch farms right now.',
                      size: Dimensions.font18,
                      color: Theme.of(context).primaryColor,
                    ),
                  ],
