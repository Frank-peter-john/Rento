...
import 'office_amenities.dart';

class AddOfficeImagesScreen extends StatefulWidget {
  final String officeName;
  const AddOfficeImagesScreen({super.key, required this.officeName});

  @override
  State<AddOfficeImagesScreen> createState() => _AddOfficeImagesScreenState();
}

class _AddOfficeImagesScreenState extends State<AddOfficeImagesScreen> {
...
// THIS METHOD SAVES IMAGES TO FIREBASE
  Future<void> _saveImagesToFirebase() async {
    ...
    final officeName = widget.officeName;

    for (var image in _selectedImages) {
      final fileName = DateTime.now().millisecondsSinceEpoch.toString();
      final reference =
          storage.ref().child('users/$userId/$officeName/$fileName');
      ...
      final propertiesRef = userRef.collection('properties').doc(officeName);
    ...
    Navigator.push(context, MaterialPageRoute(builder: (ctx) {
      return OfficeAmenities(officeName: officeName);
    }));
  }
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            SmallText(
              text: "Now, add your office images. ",
