...
import 'package:rento/screens/property/rent_your_property/add_apartment/apartment_amenities.dart';
...
class AddApartmentImagesScreen extends StatefulWidget {
  final String apartmentName;
  const AddApartmentImagesScreen({super.key, required this.apartmentName});

  @override
  State<AddApartmentImagesScreen> createState() =>
      _AddApartmentImagesScreenState();
}

class _AddApartmentImagesScreenState extends State<AddApartmentImagesScreen> {
...
// THIS METHOD SAVES IMAGES TO FIREBASE
  Future<void> _saveImagesToFirebase() async {
    ...
    final apartmentName = widget.apartmentName;

    for (var image in _selectedImages) {
      final fileName = DateTime.now().millisecondsSinceEpoch.toString();
      final reference =
          storage.ref().child('users/$userId/$apartmentName/$fileName');
      ...
      final propertiesRef = userRef.collection('properties').doc(apartmentName);
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            SmallText(
              text: "Now, add your apartment images. ",
