...
class ApartmentAmenities extends StatefulWidget {
  final String apartmentName;
  const ApartmentAmenities({super.key, required this.apartmentName});

  @override
  State<ApartmentAmenities> createState() => _ApartmentAmenitiesState();
}

class _ApartmentAmenitiesState extends State<ApartmentAmenities> {
    ...
    return Scaffold(
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            const TopNavigation(
              text: "Add your apartment amenities",
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  SmallText(
                    text: "What amenities does your apartment have?",
                    size: Dimensions.font16,
                  ),
                  SizedBox(height: Dimensions.height20),
