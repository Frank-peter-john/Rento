...
class AddShopImagesScreen extends StatefulWidget {
  final String shopName;
  const AddShopImagesScreen({super.key, required this.shopName});

  @override
  State<AddShopImagesScreen> createState() => _AddShopImagesScreenState();
}

class _AddShopImagesScreenState extends State<AddShopImagesScreen> {
...
// THIS METHOD SAVES IMAGES TO FIREBASE
  Future<void> _saveImagesToFirebase() async {
    ...
    for (var image in _selectedImages) {
      ...
      final reference =
          storage.ref().child('users/$userId/$shopName/$fileName');
      ...
      final propertiesRef = userRef.collection('properties').doc(shopName);
